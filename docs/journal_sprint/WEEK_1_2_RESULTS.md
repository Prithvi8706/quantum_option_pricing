...
[replacement working manuscript](MANUSCRIPT_WORKING_DRAFT.md).

Subsequent work: [V2A actual-contract price-bound results](PRICING_GATE_V2A_RESULTS.md)
and [V2B tighter grid bounds](PRICING_GATE_V2B_RESULTS.md)
now implement and test the first application-level gate. The original sprint
results below remain unchanged historical evidence.
