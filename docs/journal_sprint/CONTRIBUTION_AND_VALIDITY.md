...
Historical proposal: current claims and gaps are in the
[week-9 audit](WEEK_9_CLAIM_EVIDENCE.md). In particular, the statements below
about absent calibration guarantees and illustrative bounds are superseded.
The proposed controller is not a demonstrated successful contribution.
