...
IDS = {"bae": "2412.04394v5", "biqae": "2507.23074v2", "noisy_mle": "2006.16223",
       "iqae_bias": "2311.16560v2", "geometric": "2609.02715v1", "quantum_qmc": "2609.03625v1"}
...
def main():
    ...
    def fetch(item):
        ...
        result = {"name": name, "url": url, "resolved_url": response.url,
                  "sha256": hashlib.sha256(response.content).hexdigest(),
                  "pages": text.count("\f"), "characters": len(text)}
