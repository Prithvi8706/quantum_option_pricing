...
The technical first-two-week feasibility work is now complete: see the
[week 1–2 closeout](docs/journal_sprint/WEEK_1_2_CLOSEOUT.md) and
[replacement manuscript draft](docs/journal_sprint/MANUSCRIPT_WORKING_DRAFT.md).
Contributor confirmation and later-stage validation remain outstanding.
