    ...
    for cid in CONFIGS:
        ...
        for replicate in REPLICATES:
            ...
            sampler = RecordingSampler(
                Sampler(options={"seed": generator(skey)}), shots=shots)
            ...
            record = {
                ...
                "q_total": q_total, "L": L, "U": U, "shots": shots,
            ...
            weighted = [(k, n) for k, n in zip(powers, shot_list)
                       if n is not None]
            weighted_powers = [k for k, _ in weighted]
            weighted_shots = [n for _, n in weighted]
            append_record(res_path, {
                ...
                "m_a_executed": m_a_executed(weighted_powers, weighted_shots),
                "m_q_executed": m_q_executed(weighted_powers, weighted_shots),
