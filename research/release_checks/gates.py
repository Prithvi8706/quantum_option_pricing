...
GATES = {'human_novelty_review', 'physical_execution_budget',
         'matched_quantum_classical_advantage', 'fresh_confirmation',
...
def scientific_status(gates):
    ...
    return {'submission_ready': False, 'confirmation_admitted': False,
